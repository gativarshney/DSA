...
// Time Complexity: O(N) {unordered_map insertions}
...
//* Recursive DFS may not yield correct results for top view as it might visit deeper nodes before shallower ones at the same vertical line.